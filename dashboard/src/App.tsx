...
import { Bot, Clock, Wifi, WifiOff, Sparkles, Star, Users, Zap } from 'lucide-react';
...
type Tab = 'agents' | 'tasks' | 'memories' | 'characters' | 'models';
...
export default function App() {
  ...
  const tabs = [
    ...
    { id: 'characters' as Tab, label: '角色管理',   icon: Users },
